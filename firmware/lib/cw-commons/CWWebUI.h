...
body{font-family:sans-serif;font-size:32px;background:#1a1a2e;color:#e0e0e0;min-height:100vh}
...
.hdr-info{flex:1}
.hdr-title{font-size:1.3em;font-weight:bold;color:#fff}
.hdr-sub{font-size:.95em;color:#c8e6c9}
.nav{background:#16213e;padding:8px 12px;display:flex;flex-wrap:wrap;gap:8px;justify-content:center}
.nav a{display:inline-block;padding:10px 18px;border-radius:6px;text-decoration:none;font-size:1em;font-weight:600;color:#ccc;background:#0f3460;transition:background .2s}
...
.section-title{background:#0f3460;padding:10px 14px;font-size:1em;font-weight:600;color:#90caf9;letter-spacing:.5px;text-transform:uppercase}
...
.row label{font-size:1em;color:#b0bec5;flex:1;min-width:120px}
.row .ctrl{flex:2;min-width:160px}
input[type=text],input[type=number],input[type=password],select{width:100%;padding:8px 10px;background:#0f3460;border:1px solid #1e3a5f;border-radius:4px;color:#e0e0e0;font-size:1em}
input[type=range]{width:100%;accent-color:#e94560}
input[type=checkbox]{width:18px;height:18px;accent-color:#e94560}
.hint{font-size:.9em;color:#607d8b;margin-top:3px}
.btn{display:inline-block;padding:10px 22px;border-radius:6px;border:none;cursor:pointer;font-size:1em;font-weight:600;transition:background .2s}
...
.footer{padding:14px;display:flex;gap:10px;flex-wrap:wrap;justify-content:center}
.toast{position:fixed;bottom:20px;right:20px;background:#2e7d32;color:#fff;padding:10px 18px;border-radius:6px;font-size:1em;opacity:0;transition:opacity .3s;pointer-events:none;z-index:99}
.toast.show{opacity:1}
.ver-badge{background:#0f3460;border-radius:4px;padding:3px 8px;font-size:1em;color:#90caf9;font-family:monospace}
.small{font-size:1em;color:#90a4ae}
</style>
</head>
)"""";
